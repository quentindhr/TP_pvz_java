...
public class ZombieRepository implements ZombieDAO {
    ...
    public void createZombie(Zombie zombie) {
        String sql = "INSERT INTO zombies (id_zombie, nom, point_de_vie, attaque_par_seconde, degat_attaque, vitesse_de_deplacement, chemin_image, id_map) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public Zombie getZombieById(String id) {
        String sql = "SELECT * FROM zombies WHERE id_zombie = ?";
