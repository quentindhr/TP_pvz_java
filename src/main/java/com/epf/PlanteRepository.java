...
public class PlanteRepository implements PlanteDAO {
    ...
    public void createPlante(Plante plante) {
        String sql = "INSERT INTO plantes (id_plante, nom, point_de_vie, attaque_par_seconde, degat_attaque, cout, soleil_par_seconde, effet, chemin_image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void deletePlante(String id) {
        String sql = "DELETE FROM plantes WHERE id_plante = ?";
